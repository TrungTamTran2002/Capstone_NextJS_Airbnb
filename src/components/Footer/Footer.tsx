const Footer = () => {
  return (
    <div className="border-t border-gray-200 mt-5 pt-5 bg-gray-100">
      ...
      <div className="bg-gray-50 border-gray-200 z-0 fixed bottom-0 w-screen py-3 hidden md:block ">
        <div className="container mx-auto px-10 flex justify-between items-center text-gray-500 ">
          ...
          <div className="text-gray-700">
            ...
            <span className="font-medium hover:underline">
              Hỗ trợ tài nguyên <i className="fa fa-angle-up" />
            </span>
          </div>
        </div>
      </div>
